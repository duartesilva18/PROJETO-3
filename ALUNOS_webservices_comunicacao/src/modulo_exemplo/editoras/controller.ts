import {Body, Controller, Delete, Get, Param, Patch, Post, Res, UploadedFile, UseInterceptors, Headers, UseGuards} from '@nestjs/common';
...
export class EditoraController {
    ...
    getEditoras(@Headers("authorization") auth: string){
        ...
        // se necessário extraír o utilizador logado por alguma razão:
        // - incluir @Headers("authorization") auth: string acima e:
